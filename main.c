...
/* The next three functions are auxiliary functions for an integer hash table */
...
int int_hash(void *d)
{
  int *it;        // these two lines cast "void* d" to an "int*". this is 
  it = (int*) d;  // safe because main.c knows it put int*s into the table.
